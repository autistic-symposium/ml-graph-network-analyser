...
NETWORK_FILES_DIR = constants.NETWORK_FILES_DIR_COMMUNICATION 
NETWORK_FILES_UN = constants.NETWORK_FILES_UN_COMMUNICATION 
...
def main():
    ...
    running.sampling_dir(NETWORK_FILES_DIR, PATH_2_INPUT, TYPE_NET_DIR, NUM_SAMPLES, PATH_2_OUTPUT, DEPTH)
