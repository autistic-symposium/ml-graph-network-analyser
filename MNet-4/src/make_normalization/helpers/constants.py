...
NETWORK_FILES_DIR_SOCIAL_II = ["wiki-Vote.txt", "soc-Slashdot0902.txt", "soc-Slashdot0811.txt", "soc-Epinions1.txt"]


NETWORK_FILES_DIR_SOCIAL = ["twitter", "gplus"]  
NETWORK_FILES_UN_SOCIAL = ["facebook", "out.advogato", "out.dbpedia-occupation", "out.munmun_twitter_social", "out.petster-friendships-hamster", "out.petster-hamster", "out.slashdot-zoo", "out.ucidata-gama", "out.ucidata-zachary", "out.youtube-groupmemberships"]  
