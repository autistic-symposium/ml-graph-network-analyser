...
NETWORK_FILES_DIR_SOCIAL_II = ["wiki-Vote.txt", "soc-Slashdot0902.txt", "soc-Slashdot0811.txt", "soc-Epinions1.txt", "soc-pokec-relationships.txt"]#, "soc-LiveJournal1.txt" ]   

NETWORK_FILES_DIR_SOCIAL = ["twitter", "gplus"]  
NETWORK_FILES_UN_SOCIAL = ["facebook"]  




NETWORK_FILES_UN_AUTO = ["as20000102.txt", "as-skitter.txt", "oregon1_010331.txt", "oregon1_010407.txt", "oregon1_010414.txt", "oregon1_010421.txt", "oregon1_010428.txt", "oregon1_010505.txt", "oregon1_010512.txt", "oregon1_010519.txt", "oregon1_010526.txt", "oregon2_010331.txt", "oregon2_010407.txt", "oregon2_010414.txt", "oregon2_010421.txt", "oregon2_010428.txt", "oregon2_010505.txt", "oregon2_010512.txt", "oregon2_010519.txt", "oregon2_010526.txt"]
...
NETWORK_FILES_UN_COLLABORATION = ["ca-AstroPh.txt", "ca-CondMat.txt", "ca-GrQc.txt", "ca-HepPh.txt", "ca-HepTh.txt" ] 

NETWORK_FILES_UN_COMMUNICATION = ["email-Enron.txt"]
NETWORK_FILES_DIR_COMMUNICATION = ["email-EuAll.txt", "wiki-Talk.txt"]
...
NETWORK_FILES_DIR_MEME = ["higgs-mention_network.edgelist", "higgs-reply_network.edgelist", "higgs-retweet_network.edgelist", "higgs-social_network.edgelist" ] 
...
NETWORK_FILES_UN_ROAD = ["roadNet-CA.txt", "roadNet-PA.txt", "roadNet-TX.txt"] 
...
NETWORK_FILES_DIR_WEBGRAPHS = ["web-BerkStan.txt", "web-Google.txt", "web-NotreDame.txt", "web-Stanford.txt"]

NETWORK_FILES_DIR_WIKI = ["wiki-Talk.txt", "wiki-Vote.txt"]#, "wikiElec.ElecBs3.txt"]
